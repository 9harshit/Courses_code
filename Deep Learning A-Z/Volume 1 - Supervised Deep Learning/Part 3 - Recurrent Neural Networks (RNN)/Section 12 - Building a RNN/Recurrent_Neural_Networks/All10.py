...
training_set1 = dataset_train.iloc[:, 0:5].values
...
regressor.save("All10.h5")

from keras.models import load_model

regressor=load_model('All10.h5')
...
dataset_total = pd.concat((dataset_train, dataset_test), axis = 0, sort = True)
...
regressor.save("All.h5")
plt.plot(real_stock_price[:,0], color = 'red', marker = 'o', label = 'Real Google Stock Open Price')
...
plt.plot(real_stock_price[:,1], color = 'red', marker = 'o', label = 'Real Google Stock High Price')
...
plt.plot(real_stock_price[:,2], color = 'red',  marker = 'o',label = 'Real Google Stock Low  Price')
...
plt.plot(real_stock_price[:,3], color = 'red', marker = 'o',label = 'Real Google Stock Close Price')
